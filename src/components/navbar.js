		...
		<nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800">
			<div class="container flex flex-wrap justify-between items-center mx-auto">
				<a href="/" class="flex items-center">
					<img
						src="https://res.cloudinary.com/elizapardo/image/upload/v1655664904/logo_token_bwpxlt.webp"
				...
				<div class="flex md:order-2">
					<button
						href="/contacto"
						type="button"
						class="text-Yellow-custom bg-Purple-dark hover:bg-Purple-light focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
					>
						Contacto
					</button>
					<button
