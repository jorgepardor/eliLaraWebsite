...
const [menuToggle, setMenuToggle] = useState(false);
	...
	return (
		...
		<nav className=" bg-Purple-dark  px-2 sm:px-4 py-2.5  dark:bg-gray-800">
			<div className="container flex justify-between items-center mx-auto">
				...
				>
					...
					<a
						href="/contacto"
						type="button"
						className="font-Mukta text-Yellow-custom bg-Purple-dark hover:bg-Purple-light focus:ring-4 focus:outline-none focus:ring-Purple-dark font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0"
					>
						Contacto
					</a>
